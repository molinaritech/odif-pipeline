...
def test_transform_sales_data_adds_unit_price_column(valid_sales_df) -> None:
 
    transformed_df = transform_sales_data(valid_sales_df)

    assert UNIT_PRICE_COLUMN in transformed_df.columns

def test_transform_sales_data_calculates_unit_price(valid_sales_df) -> None:
